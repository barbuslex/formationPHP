...
$joueur3->faireHeadshot();
$joueur3->marquerPoint();
$joueur2->subirDegats(110);
...
echo "Joueurs vivants Terroristes: " . $terroristes->joueursVivants() . "\n";
echo "Joueurs vivants Contre-Terroristes: " . $contreTerroristes->joueursVivants() . "\n";
